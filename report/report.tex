...
Each created task will generate eight new tasks at next split.
If we look at the first values : 8 tasks are created for the first split, then each of these 8 tasks create 8 tasks : 64 new tasks adding to the existing 8 ones.
